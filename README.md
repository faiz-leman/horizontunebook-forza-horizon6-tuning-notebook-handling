...
<div align="center">
  <img src="./public/logo.svg" alt="HorizonTuneBook — Forza Horizon 6 — Handling" width="64" height="64">
  <h1>HorizonTuneBook — Forza Horizon 6 — Handling</h1>
</div>

An independent project specification for Forza Horizon 6, covering tuning preset worksheets, route test conditions, lap comparison records.
...
<img src="./public/screenshots/desktop-main.svg" alt="Forza Horizon 6 — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Forza Horizon 6 — compact concept, not a screenshot" width="250">
<br>
...
- **Tuning preset worksheets** — planned module; not implemented.
- **Route test conditions** — planned module; not implemented.
- **Lap comparison records** — planned module; not implemented.

The proposed workflow separates tuning preset worksheets from route test conditions, with lap comparison records retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Tuning preset worksheets**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="HorizonTuneBook — Forza Horizon 6 — Handling — specification review workflow">
<br>
...
### Tuning preset worksheets

Define the input and expected outcome for module 1. Record the Forza Horizon 6 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Route test conditions

Define the input and expected outcome for module 2. Record the Forza Horizon 6 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Lap comparison records

Define the input and expected outcome for module 3. Record the Forza Horizon 6 version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.
...
| Planned output | Tuning preset worksheets |
