...
独立的项目设计文档，适用对象： **Forza Horizon 6**。
...
- **调校预设工作表** (Tuning preset worksheets) — 规划模块，尚未实现。
- **路线测试条件** (Route test conditions) — 规划模块，尚未实现。
- **圈速比较记录** (Lap comparison records) — 规划模块，尚未实现。
